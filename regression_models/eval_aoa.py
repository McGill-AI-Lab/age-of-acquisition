...
AOA_PATH = PROJECT_ROOT / "data" / "processed" / "lookup_tables" / "aoa_table.parquet"
OUTPUT_PLOT = PROJECT_ROOT / "outputs" / "plots" / "aoa_correlation.png"
...
def main(embeddings_dir: Path) -> None:
    ...
    print(f"  AoA norms: {len(aoa_df)} words")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Benchmark word embeddings by predicting AoA.")
    parser.add_argument(
        "--embeddings-dir",
        type=str,
        default=None,
